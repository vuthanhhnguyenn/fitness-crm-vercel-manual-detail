...
import { getCrmMainContractsByIdChangeHistoryOptions } from '@/lib/api/@tanstack/react-query.gen';
import type { GetCrmMainContractsByIdChangeHistoryResponse } from '@/lib/api/types.gen';

type HistoryRow = GetCrmMainContractsByIdChangeHistoryResponse['history'][number];
...
export function HistoryTab({ contractId }: HistoryTabProps) {
  const { data, isLoading } = useQuery({
    ...getCrmMainContractsByIdChangeHistoryOptions({ path: { id: contractId } }),
  });
