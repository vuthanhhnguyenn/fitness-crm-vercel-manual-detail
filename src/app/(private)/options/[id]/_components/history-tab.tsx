...
import { getCrmOptionsByIdChangeHistoryOptions } from '@/lib/api/@tanstack/react-query.gen';
import type { GetCrmOptionsByIdChangeHistoryResponse } from '@/lib/api/types.gen';

type HistoryRow = GetCrmOptionsByIdChangeHistoryResponse['history'][number];

interface HistoryTabProps {
  optionId: string;
}

export function HistoryTab({ optionId }: HistoryTabProps) {
  const { data, isLoading } = useQuery({
    ...getCrmOptionsByIdChangeHistoryOptions({ path: { id: optionId } }),
  });
