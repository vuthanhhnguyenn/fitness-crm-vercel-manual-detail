...
export const SEED_VISIT_EXPERIENCES: VisitExperienceDetail[] = [
  ...
  },
  {
    ...
    enrolled_at: makeVeDate(0, 11, 25),
    enrolled_application_id: 'APP-2026-0001',
    cancelled_at: null,
    timeline: [
      {
  ...
  },
  {
    ...
    enrolled_at: null,
    enrolled_application_id: null,
    cancelled_at: makeVeDate(0, 12, 55),
    timeline: [
      {
  ...
  },
  {
    ...
    enrolled_at: makeVeDate(-1, 14, 30),
    enrolled_application_id: 'APP-2026-0002',
    cancelled_at: null,
    timeline: [
      {
  ...
  },
  {
    ...
    enrolled_at: null,
    enrolled_application_id: null,
    cancelled_at: makeVeDate(-1, 10, 50),
    timeline: [
      {
  ...
  },
  {
    ...
    enrolled_at: makeVeDate(-2, 14, 55),
    enrolled_application_id: 'APP-2026-0003',
    cancelled_at: null,
    timeline: [
      {
  ...
  },
  {
    ...
    enrolled_at: null,
    enrolled_application_id: null,
    cancelled_at: makeVeDate(-5, 15, 35),
    timeline: [
      {
  ...
  },
  {
    ...
    enrolled_at: makeVeDate(-8, 12, 0),
    enrolled_application_id: 'APP-2026-0004',
    cancelled_at: null,
    timeline: [
      {
